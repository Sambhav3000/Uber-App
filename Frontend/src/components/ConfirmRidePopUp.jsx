    ...
    <h5  onClick={()=>{
      ...
      <div className='flex gap-2 justify-between flex-col items-center'>
        ...
        <div className='mt-6'>
          ...
          <input value={otp} onChange={(e)=>setOtp(e.target.value)} type="text" className='bg-[#eee] px-6 py-4 font-mono text0lg rounded-lg w-full mt-3' placeholder='Enter OTP' />

            <Link to='/captain-riding' className='w-full mt-5 text-lg flex justify-center bg-green-400 text-white font-semibold p-2 rounded-lg'>Accept</Link>

            <button onClick={()=>{
            props.setConfirmRidePopupPanel(false)
            props.setRidePopupPanel(false)
            }} className='w-full mt-2 bg-red-600 text-gray-700 text-lg font-semibold p-2 rounded-lg'>Canncel
            </button>
          </form>
